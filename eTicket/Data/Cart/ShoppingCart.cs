...
{
    //This is a class add data to a shopping cart and remove from data
    ...
    public class ShoppingCart
    {
        ...
        public static ShoppingCart GetShoppingCart(IServiceProvider services)
        {
            ...
            string cartId = session.GetString("CartId") ?? Guid.NewGuid().ToString(); //search for the cartıd if this is null generate a new cartıd
